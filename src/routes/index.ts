...
routes.use(addonGroupRoutes);
routes.use(couponRoutes);
routes.use(mesaRoutes);
routes.use(reciboRoutes);
routes.use(pdvRoutes);
routes.use(despesasRoutes);
routes.use(moduleRoutes);
routes.use(printDeviceRoutes);
routes.use(printJobRoutes);
routes.use(agentProductRoutes);
